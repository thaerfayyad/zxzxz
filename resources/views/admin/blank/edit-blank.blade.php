...
@section('title',__("str.Haji Karak"). __("str.Edit Category"))
@section('description', __("str.Haji Karak"). __("str.Edit Category"))
@section('author', __("str.Haji Karak"). __("str.Edit Category"))
@section('keywords', __("str.Haji Karak"). __("str.Edit Category"))
@section('copyright', __("str.Haji Karak"). __("str.Edit Category"))
@section('css')
@endsection
@php
    $lang = config('app.locale');
    $path = 'uploads/categories/'.$blank->image;
    $type = pathinfo($path, PATHINFO_EXTENSION);
    $data = file_get_contents($path);
    $blank_image = 'data:image/' . $type . ';base64,' . base64_encode($data);
@endphp
@section('content')
    <!--begin::Content-->

    <input type="hidden" id="item_id" value="{{$blank->id}}">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__("str.Edit Category")}}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{__("str.Edit Category")}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div id="kt_ecommerce_add_blank_form" class="form d-flex flex-column flex-lg-row"
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    <div id="uploaded_image" class="image-input-wrapper w-150px h-150px"
                                         style="background-image: url(<?php echo $blank_image ?>)"></div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle bg-success w-15px h-15px {{$blank->status ==  1 ? "bg-success": "bg-danger"}}"
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <option></option>
                                    <option value="published" {{$blank->status ==  1 ? "selected": ""}}>{{__("str.Published")}}</option>
                                    <!--                                    <option value="scheduled">Scheduled</option>-->
                                    <option value="unpublished" {{$blank->status ==  0 ? "selected": ""}}>{{__("str.Unpublished")}}</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input id="blank_name" type="text" name="blank_name" class="form-control mb-2"
                                           placeholder="{{__("str.Category name")}}"
                                           value="{{$blank->getTranslation('name', "ar")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input id="blank_name_en" type="text" name="blank_name_en"
                                           ...
                                           placeholder="{{__("str.Category name")}}"
                                           value="{{$blank->getTranslation('name', "en")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Error-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_title" type="text" class="form-control mb-2" name="meta_title"
                                           ...
                                           value="{{$blank->getTranslation('meta_title', "ar")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_title_en" type="text" class="form-control mb-2" name="meta_title"
                                           placeholder="{{__("str.Meta tag name")}}"
                                           value="{{$blank->getTranslation('meta_title', "en")}}"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.Set a meta tag title. Recommended to be simple and precise keywords.")}}
                                    </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_description" type="text" class="form-control mb-2"
                                           ...
                                           value="{{$blank->getTranslation('meta_description', "ar")}}"/>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <input id="meta_description_en" type="text" class="form-control mb-2"
                                           name="meta_description"
                                           placeholder="{{__("str.Meta tag Description")}}"
                                           value="{{$blank->getTranslation('meta_description', "en")}}"/>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__("str.Set a meta tag description to the blank for increased SEO ranking.")}}
                                    </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button id="kt_ecommerce_edit_blank_submit" class="btn btn-primary">
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/blank/edit_blank.js') }}" defer></script>
@endsection
