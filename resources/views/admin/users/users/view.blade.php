...
@section('title',__("str.User ").$user->name)
@section('description',__("str.User"))
@section('author',__("str.User"))
@section('keywords',__("str.User"))
@section('copyright',__("str.User"))
@section('css')
@endsection
@section('content')
    <!--begin::Content-->
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/users/edit_user.js') }}" defer></script>
@endsection
