        ...
        init: function () {
            (() => {
                ...
                const r = e => {
                    ...
                    var t = "assets/media/" + e.element.getAttribute("data-kt-select2-country"),
                ...
                t.forEach((e => {
                    e.addEventListener("change", (t => {
                        ...
                        o.classList.remove(...a), o.classList.add("col", "my-2"), o.innerHTML = "", i.classList.add(...a), i.classList.add("border", "border-dashed", "rounded", "p-3", "bg-white"), i.innerHTML = n, o.appendChild(i);
                        const s = o.getAttribute("data-kt-ecommerce-edit-order-id");
                        if (t.target.checked) r.appendChild(o); else {
                            const e = r.querySelector('[data-kt-ecommerce-edit-order-id="' + s + '"]');
                            e && r.removeChild(e)
                        }
                        d()
                    }))
